        ...
        <div className="min-h-screen relative text-white overflow-x-hidden scroll-smooth">
            ...
            >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-black tracking-tight">
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-amber-400 to-amber-300 drop-shadow-lg">
                                    QUANTUM
                                </span>
                                <span className="text-white drop-shadow-lg">PLAN</span>
                            </h1>
                            <p className="text-xs text-amber-200/70 font-bold tracking-[0.3em] uppercase">Luxury Furniture Design</p>
                        </div>
                    </div>

                    <button
                        onClick={onStart}
                        className="group px-10 py-4 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/20 hover:border-amber-400/60 backdrop-blur-2xl font-bold text-base transition-all duration-300 flex items-center gap-3 shadow-2xl hover:shadow-amber-500/30 hover:scale-105"
                    >
                ...
                <div className="relative z-20 flex-1 flex flex-col items-center justify-center px-8 pb-32">
                    <div className="text-center max-w-6xl">
                        ...
                        {/* Hero Title */}
                        <h1 className="text-8xl md:text-[10rem] lg:text-[12rem] font-black tracking-tighter mb-10 leading-[0.85]">
                            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white via-amber-50 to-white drop-shadow-[0_0_60px_rgba(255,255,255,0.3)]">
                                Luxury
                            </span>
                            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-400 to-amber-200 drop-shadow-[0_0_100px_rgba(251,191,36,0.6)]">
                                Redefined
                            </span>
                        </h1>
            ...
            >
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-8 text-center">
                    ...
                    {/* Main Heading */}
                    <h2 className="text-9xl font-black mb-8 leading-tight drop-shadow-2xl">
                        <span className="block text-white animate-fade-in">
                            Furniture That
                        </span>
                        <span className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-200 via-amber-400 to-amber-200 drop-shadow-[0_0_80px_rgba(251,191,36,0.8)]">
                            Tells A Story
                        </span>
                    </h2>
            ...
            >
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src="/pexels-quark-studio-1159039-2506991.jpg"
                        alt="Background"
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-8">
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-3 gap-10 transition-all duration-1000 delay-200 ${isVisible.features ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
                        ...
                        <div className={`group relative rounded-[2.5rem] overflow-hidden transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_0_80px_rgba(251,191,36,0.4)] ${isVisible.features ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`} style={{ transitionDelay: '300ms' }}>
                            ...
                            <div className="absolute inset-0 z-0">
                                <img
                                    src="/pexels-artbovich-7195534.jpg"
                        ...
                        <div className={`group relative rounded-[2.5rem] overflow-hidden transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_0_80px_rgba(168,85,247,0.4)] ${isVisible.features ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`} style={{ transitionDelay: '500ms' }}>
                            ...
                            <div className="absolute inset-0 z-0">
                                <img
                                    src="/pexels-artbovich-7166926.jpg"
                                    alt="3D Rendering"
                                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                />
                                <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/70 to-black/90" />
                        ...
                        <div className={`group relative rounded-[2.5rem] overflow-hidden transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_0_80px_rgba(59,130,246,0.4)] ${isVisible.features ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}`} style={{ transitionDelay: '700ms' }}>
                            ...
                            <div className="absolute inset-0 z-0">
                                <img
                                    src="/pexels-artbovich-7511749.jpg"
                                    alt="Virtual Reality"
                                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                />
                                <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/70 to-black/90" />
                    ...
                    <div className="relative mt-40">
                        <div className="relative bg-black rounded-[4rem] overflow-hidden shadow-[0_20px_100px_rgba(0,0,0,0.5)] border border-white/10 group">
                            ...
                            <div className="absolute inset-0 opacity-40 transition-transform duration-1000 group-hover:scale-105">
                                <img
                                    src="/pexels-hello-pipcke-1008732483-20285350.jpg"
            ...
            >
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-8">
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 transition-all duration-1000 delay-300 ${isVisible.gallery ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
                        ...
                        <div className="group relative overflow-hidden rounded-[2rem] h-[290px]">
                            <img
                                src="/pexels-vika-glitter-392079-1648776.jpg"
                                alt="Luxury Furniture"
                                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
